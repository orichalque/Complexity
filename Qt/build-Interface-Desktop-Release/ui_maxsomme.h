...
public:
    ...
    void setupUi(QMainWindow *MaxSomme)
    {
        ...
        maxSommeResult = new QLineEdit(splitter);
        ...
        menuBar->setGeometry(QRect(0, 0, 1229, 24));
    ...
    void retranslateUi(QMainWindow *MaxSomme)
    {
        ...
        maxSommeResult->setText(QApplication::translate("MaxSomme", "tgjdj", 0, QApplication::UnicodeUTF8));
