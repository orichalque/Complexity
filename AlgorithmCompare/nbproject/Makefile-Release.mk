...
${OBJECTDIR}/PairAlgorithm.o: PairAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PairAlgorithm.o PairAlgorithm.cpp

${OBJECTDIR}/PairAlgorithm2.o: PairAlgorithm2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PairAlgorithm2.o PairAlgorithm2.cpp

${OBJECTDIR}/QuickAlgorithm.o: QuickAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuickAlgorithm.o QuickAlgorithm.cpp

${OBJECTDIR}/RecursiveAlgorithm.o: RecursiveAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RecursiveAlgorithm.o RecursiveAlgorithm.cpp
